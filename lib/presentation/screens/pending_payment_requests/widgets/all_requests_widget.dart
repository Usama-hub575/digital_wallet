      ...
      child: BlocBuilder<DashboardBloc, DashboardState>(
        builder: (context, state) {
          return ListView.separated(
            shrinkWrap: true,
            physics: const BouncingScrollPhysics(),
            itemCount: state.requestsResponseModel.all.length,
            ...
            itemBuilder: (context, index) {
              return ListTile(
                ...
                onTap: () {},
                title: Text(
                  state.requestsResponseModel.all[index].senderName
                      .toUpperCase(),
                ...
                subtitle: Text(
                  state.requestsResponseModel.all[index].status.toUpperCase(),
                  style: textStyles.semiBold.copyWith(
                ...
                trailing: InkWell(
                  onTap: () => Navigator.pushNamed(
                    ...
                    arguments: {
                      "data": state.requestsResponseModel.all[index],
                    },
                  ),
                  child: Text(
                    "See Detail",
